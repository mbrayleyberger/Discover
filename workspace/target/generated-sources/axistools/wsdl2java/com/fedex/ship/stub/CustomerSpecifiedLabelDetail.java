...
public class CustomerSpecifiedLabelDetail  implements java.io.Serializable {
    ...
    /* Customer-provided SCNC for use with label-data-only processing
     * of FedEx Ground shipments. */
    private org.apache.axis.types.NonNegativeInteger scncOverride;
    ...
    public CustomerSpecifiedLabelDetail(
           ...
           org.apache.axis.types.NonNegativeInteger scncOverride,
    ...
    /**
     * Gets the scncOverride value for this CustomerSpecifiedLabelDetail.
     * 
     * @return scncOverride   * Customer-provided SCNC for use with label-data-only processing
     * of FedEx Ground shipments.
     */
    public org.apache.axis.types.NonNegativeInteger getScncOverride() {
        return scncOverride;
    }


    /**
     * Sets the scncOverride value for this CustomerSpecifiedLabelDetail.
     * 
     * @param scncOverride   * Customer-provided SCNC for use with label-data-only processing
     * of FedEx Ground shipments.
     */
    public void setScncOverride(org.apache.axis.types.NonNegativeInteger scncOverride) {
        this.scncOverride = scncOverride;
    }
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        ...
        _equals = true && 
            ...
            ((this.scncOverride==null && other.getScncOverride()==null) || 
             (this.scncOverride!=null &&
              this.scncOverride.equals(other.getScncOverride()))) &&
    ...
    public synchronized int hashCode() {
        ...
        if (getScncOverride() != null) {
            _hashCode += getScncOverride().hashCode();
        }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v9", "CustomerSpecifiedLabelDetail"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v9", "CustomContent"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v9", "CustomLabelDetail"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("configurableReferenceEntries");
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v9", "ConfigurableReferenceEntries"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v9", "ConfigurableLabelReferenceEntry"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v9", "MaskedData"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v9", "LabelMaskableDataType"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        elemField.setMaxOccursUnbounded(true);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("scncOverride");
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v9", "ScncOverride"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v9", "TermsAndConditionsLocalization"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v9", "Localization"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("additionalLabels");
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v9", "AdditionalLabels"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v9", "AdditionalLabelsDetail"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        elemField.setMaxOccursUnbounded(true);
        typeDesc.addFieldDesc(elemField);
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v9", "AirWaybillSuppressionCount"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "nonNegativeInteger"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
