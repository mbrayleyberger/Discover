...
public class StringBarcodeType implements java.io.Serializable {
    ...
    public static final java.lang.String _FDX_1D = "FDX_1D";
    ...
    public static final StringBarcodeType FDX_1D = new StringBarcodeType(_FDX_1D);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v9", "StringBarcodeType"));
    }
    /**
